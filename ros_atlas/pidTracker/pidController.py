...
try:
    ...
    from custom_ros_action.msg import InitDroneGoal, InitDroneResult, InitDroneFeedback, InitDroneAction
...
class ManualControlServer:
    def __init__(self, name) -> None:
        self.action_client = SimpleActionClient('action_name, ActionType')
...
def main():
    ...
    rospy.init_node('smach_ex_actionlib')

    # Start an Action server
    server = InitDroneServer('init_drone')
