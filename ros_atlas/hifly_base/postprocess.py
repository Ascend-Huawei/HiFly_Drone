...
def postprocess(frame, outputs):
    ...
    anchors = get_anchors()
    # image_shape = [720, 960]      # TelloCamera dimension
    image_shape = [360, 480]        # Halved TelloCamera dimension
    # image_shape = [1080, 1920]    # Pre-recorded video dimension
    # image_shape = [540, 960]      # Halved pre-recorded dimension
